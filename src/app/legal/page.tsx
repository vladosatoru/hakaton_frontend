  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Официальные документы и соглашения Центра организации дорожного движения" />
      </Head>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="py-12 text-center">
              ...
              <p className="text-xl text-text-muted max-w-2xl mx-auto">
                Официальные документы и соглашения Центра организации дорожного движения Смоленской области
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mt-16 text-center">
            <div className="card max-w-2xl mx-auto">
              ...
              <p className="text-text-muted mb-4">
                Если у вас возникли вопросы касательно наших юридических документов, 
