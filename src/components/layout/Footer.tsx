      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services/documentation" className="text-text-muted hover:text-primary transition-colors">Проектная документация</Link></li>
              <li><Link href="/services/crane" className="text-text-muted hover:text-primary transition-colors">Аренда автовышки</Link></li>
              <li><Link href="/services/evacuation" className="text-text-muted hover:text-primary transition-colors">Вызов эвакуатора</Link></li>
